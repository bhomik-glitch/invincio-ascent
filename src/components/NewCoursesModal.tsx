...
const batches = [
  ...
  },
  {
    ...
    tagline: "High-yield, fast-track revision for written exam + SSB prep.",
    description: "Available in both Online & Offline modes. Comprehensive target revision for CDS 2/2026 & NDA 2/2026 aspirants.",
