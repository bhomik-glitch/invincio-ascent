...
const batches = [
  ...
  },
  {
    ...
    tagline: "Immersive classroom preparation & fast-track revision for NDA 2/2026.",
    description: "Intensive offline revision program covering Maths, GAT, and parallel SSB personality preparation.",
    highlight: "Offline Mode",
    slots: ["03 August 2026"],
  },
  {
    title: "NDA Intense Revision Batch (Online)",
    tagline: "Live interactive fast-track revision for NDA 2/2026.",
    description: "High-yield online revision module with live classes, test series, and personality orientation.",
